...
const LeftLayout = (props) => {
     ...
     return (
          <Box flex="1" h="100%" position="relative">
               {!img && <Image src={require("../../../../images/gymLayout.jpg")} width="100%" height="100%" objectFit="cover" borderRadius="md" />}
               {img && <Image src={img} width="100%" height="100%" objectFit="cover" borderRadius="md" />}
